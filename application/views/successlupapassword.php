...
<html lang="en">
<head>
  <title>Berhasil - Sistem Pengelolaan Data Penduduk</title>
  <meta charset="UTF-8">
  ...
  <div class="limiter">
    <div class="container-login100">
      <div>
        ...
        <form class="login100-form validate-form"  action="<?php echo base_url('login/veriflupapass'); ?>" method="post" class="" role="form">
...
?>
            <h4 class="text-center">Selamat! Akun anda sudah reset password, silahkan Login!</h4><br>
            <a href="<?= base_url('login/index') ?>" class="text-center btn btn-primary">Login</a>
          </div>
        </form>
