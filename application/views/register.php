...
<html lang="en">
<head>
  <title>Register - Sistem Pengelolaan Data Penduduk</title>
  <meta charset="UTF-8">
  ...
  <div class="limiter">
    <div class="container-login100">
      <div>
        ...
        <form class="login100-form validate-form"  action="<?php echo base_url('login/register'); ?>" method="post" class="" role="form">
...
?>
          ...
          <div class="wrap-input100">
            <select name="level" id="" class="form-control">
              ...
              <option value="user">Masyarakat Desa</option>
            </select>
        ...
        <div class="text-center">
          <a href="<?= base_url('login/lupapassword') ?>">Lupa Password?</a><br>
